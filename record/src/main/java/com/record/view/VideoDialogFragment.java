...
import com.record.mode.VideoDialogMode;

/**
 * Created by robi on 2016-06-03 17:21.
 */
public class VideoDialogFragment extends RBaseDialogFragment {

    VideoDialogMode mMenuDialogMode;
    ...
    protected void initView(Bundle savedInstanceState) {
        mMenuDialogMode = new VideoDialogMode(this, mViewHolder);
